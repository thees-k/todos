...
-- Start with 100 to avoid conflicts with initial data that will be inserted later
CREATE SEQUENCE users_seq START WITH 100 INCREMENT BY 1;
CREATE SEQUENCE todo_lists_seq START WITH 100 INCREMENT BY 1;
CREATE SEQUENCE tasks_seq START WITH 100 INCREMENT BY 1;
CREATE SEQUENCE roles_seq START WITH 100 INCREMENT BY 1;


CREATE TABLE roles (
  id INTEGER DEFAULT NEXT VALUE FOR roles_seq PRIMARY KEY,
