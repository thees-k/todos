...
INSERT INTO tasks (id, title, description, todo_list_id, priority, is_done, created_at, updated_at, updated_by) VALUES (1, 'Finish report', 'Prepare Q3 report for management', 1, 1, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 2), (2, 'Review code', 'Review PR #42', 1, 2, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 2), (3, 'Buy milk', 'Organic whole milk, 1L', 3, 1, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 3), (4, 'Fix bug', 'NPE in LoginService.java', 4, 1, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 4), (5, 'Plan team event', 'Ideas for team outing', 5, 1, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 4);
