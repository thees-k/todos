...
INSERT INTO users (id, username, email, password_hash, created_at, updated_by, updated_at) VALUES (1, 'alice', 'alice@example.com', '$2a$10$lbhNMm/AJ2bDztbctzNtWu.FN6GV9Ejjl28Ab.7ylw9wJqsB/50lC', CURRENT_TIMESTAMP, null, CURRENT_TIMESTAMP), (2, 'bob', 'bob@example.com', '$2a$10$hq/YohNSNou/20lUNI1VAO7qr.nzldvMOzG15GIYZjQy8D0B.u.qC', CURRENT_TIMESTAMP, null, CURRENT_TIMESTAMP), (3, 'carol', 'carol@example.com', '$2a$10$IazaHCbTQOg3SjUnTD0DueBxXO4H7801c96I0BKTmcK2iwngTPP6y', CURRENT_TIMESTAMP, null, CURRENT_TIMESTAMP), (4, 'admin', 'admin@example.com', '$2a$10$zydPzLrV0pN7UV90nzOIje/xWsvbSjHDD6xFPbig9SDVD6FKEj3gO', CURRENT_TIMESTAMP, null, CURRENT_TIMESTAMP);
